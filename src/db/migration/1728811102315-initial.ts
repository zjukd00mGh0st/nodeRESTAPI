...
export class Initial1728811102315 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`reservas\` (\`id\` varchar(36) NOT NULL, \`nombre_usuario\` varchar(255) NOT NULL, \`cantidad_boletos\` int NOT NULL, \`fecha_reserva\` timestamp NOT NULL, \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`eventoId\` varchar(36) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
